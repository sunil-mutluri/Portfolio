...
const projects = [
  {
    ...
    image: "https://i.postimg.cc/Kct3ghPs/Chat-GPT-Image-Jun-30-2025-05-12-37-AM.png", // heart + tech
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/Y2PYQzZh/How-to-Build-a-Ride-Sharing-App-from-Scratch.webp", // car ride concept
  ...
  },
  {
    ...
    image: "https://i.postimg.cc/W3MC04b4/Gemini-Generated-Image-haqsznhaqsznhaqs.jpg", // glowing LED hands
      ...
      >
        <motion.div variants={fadeInUp} className="text-center mb-20">
          ...
          <p className="text-xl text-slate-500 max-w-2xl mx-auto font-light">
           A collection of engineered solutions that transform complex technical challenges into scalable, high-impact applications.
          </p>
        </motion.div>
